...
### Corrigido
- **Alerta de estoque**: Agora, quando a quantidade de um item atinge ou ultrapassa o valor mínimo definido, o checkbox correspondente é automaticamente desmarcado (se estiver marcado). Isso mantém a lista de compras sincronizada com a necessidade real de reposição.
- Pequenos ajustes na função `verificarAlertas` para garantir a consistência.
